        ...
        <Card>
          ...
          <CardContent>
            {loading ? (
              ...
              filtered.map(appt => (
                <div key={appt._id} className="flex items-center justify-between py-4 border-b dark:border-gray-800 last:border-0">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 dark:text-blue-400 text-sm font-bold shrink-0">
                    ...
                    <div>
                      ...
                      {appt.reason && <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Reason: {appt.reason}</p>}
                    </div>
                  </div>
