...
const { syncPatient, getMe, getDashboard, updateProfileImage, bookAppointment, getMyAppointments, getAppointmentById, getReminders, uploadReport } = require('../controllers/patientController')
